...
regexHooks = dict( # A dictionary which holds the regex that then trigger each core command. 
                  ...
                  DrainX =              re.compile(r'(?<![<,+-])(Undrain|Drain)[0-9]+'),
                  ...
                  ModifyStatus =       re.compile(r'(?<![<,+-])(Destroy|BringToPlay|SendToBottom|Commit|Uncommit|Sacrifice|Takeover|Score|Insane|Restore|Exhaust|Refresh)(Target|Host|Multi|Myself)'),
